...
void ABatteryCollectorCharacter::CollectPickups()
{
	...
	for (int32 iCollected = 0; iCollected < CollectedActors.Num(); ++iCollected)
	{
		...
		// If the Cast is succssful and the Pickup is vaild and active
		if (TestPickup && !TestPickup->IsPendingKill() && TestPickup->isActive())
		{
			// call the pick up WasCollected function
			TestPickup->WasCollected(); // call WasCollected, NOT _Implementation here to capture all code and Blueprint
