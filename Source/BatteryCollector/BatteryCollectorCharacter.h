...
public:
	...
	/** Accessor function for character's power */
	UFUNCTION(BlueprintPure, Category = "Power")
...
protected:
	...
	/** Character's speed when their power is zero*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Power", meta = (BlueprintProtected = "true"))
	float BaseSpeed;
	
	/** Implemented in Blueprint, a method to create a behavior when powering up */
